...
const reviewsMap: Record<string, ProductReview[]> = {
  '1': [
    { id: 'r1-1', author: 'Jean P.', rating: 5, title: 'Incredible quality', text: 'This template saved me an entire week. The layers are perfectly organized and the 3D model is production-ready.', date: '2026-01-15', verified: true, location: 'Paris, France' },
    { id: 'r1-2', author: 'Maria L.', rating: 5, title: 'Best purchase this year', text: 'Exactly what I needed for my residential project. Customizing it was straightforward.', date: '2026-01-10', verified: true, location: 'Barcelona, Spain' },
    { id: 'r1-3', author: 'Thomas K.', rating: 5, title: 'Professional grade', text: 'Proper layers, real annotations, not just a pretty 3D model. Highly recommend.', date: '2025-12-28', verified: true, location: 'Berlin, Germany' },
    { id: 'r1-4', author: 'Ana S.', rating: 4, title: 'Very good but', text: 'Great template overall. Would love to see more interior detail options included.', date: '2025-12-20', verified: true, location: 'Barcelona, Spain' },
    { id: 'r1-5', author: 'Lucas R.', rating: 5, title: 'Perfect for thesis', text: 'Used this for my final thesis project. Professional quality at an affordable price.', date: '2025-12-15', verified: true, location: 'São Paulo, Brazil' },
    { id: 'r1-6', author: 'Sophie B.', rating: 5, title: 'Time saver', text: 'Cut my drafting time in half. The section drawings alone are worth the price.', date: '2025-12-05', verified: true, location: 'Berlin, Germany' },
    { id: 'r1-7', author: 'Ahmed N.', rating: 5, title: 'Excellent', text: 'Clean, well-structured, ready to use. What more could you ask for?', date: '2025-11-28', verified: true, location: 'Dubai, UAE' },
  ],
  '2': [
    { id: 'r2-1', author: 'David W.', rating: 5, title: 'Perfect for our firm', text: 'We use this as a starting point for all commercial projects now. Saves us days.', date: '2026-01-20', verified: true, location: 'London, UK' },
    { id: 'r2-2', author: 'Elena R.', rating: 5, title: 'Comprehensive', text: 'The MEP coordination is already done. This is not just a shell — it is a complete project.', date: '2026-01-12', verified: true, location: 'Milan, Italy' },
    { id: 'r2-3', author: 'Mark J.', rating: 4, title: 'Great value', text: 'Very detailed for the price. Revit families are well-made.', date: '2025-12-30', verified: true, location: 'London, UK' },
    { id: 'r2-4', author: 'Yuki T.', rating: 5, title: 'Superb', text: 'The scheduling and tagging is perfect. Immediately production-ready.', date: '2025-12-18', verified: true, location: 'Tokyo, Japan' },
    { id: 'r2-5', author: 'Carlos M.', rating: 5, title: 'Highly professional', text: 'Used it for a real client project. Nobody could tell it started from a template.', date: '2025-12-01', verified: true, location: 'São Paulo, Brazil' },
  ],
  '3': [
    { id: 'r3-1', author: 'Sarah M.', rating: 5, title: 'Best bundle ever', text: 'Three templates for the price of two. Every one is high quality.', date: '2026-01-18', verified: true, location: 'London, UK' },
    { id: 'r3-2', author: 'Pierre D.', rating: 5, title: 'Firm standard', text: 'We bought this for our entire team. Consistency across projects is amazing now.', date: '2026-01-05', verified: true, location: 'Paris, France' },
    { id: 'r3-3', author: 'Lisa H.', rating: 5, title: 'Outstanding value', text: 'Each template in the bundle would be worth the full price individually.', date: '2025-12-22', verified: true, location: 'Munich, Germany' },
    { id: 'r3-4', author: 'Raj P.', rating: 5, title: 'Complete solution', text: 'From villa to apartment to townhouse — covers all residential types.', date: '2025-12-10', verified: true, location: 'Mumbai, India' },
    { id: 'r3-5', author: 'Emma K.', rating: 5, title: 'Amazing quality', text: 'The attention to detail in every template is remarkable.', date: '2025-11-25', verified: true, location: 'New York, USA' },
    { id: 'r3-6', author: 'Olivier G.', rating: 5, title: 'Must-have', text: 'If you work in residential architecture, just buy this bundle.', date: '2025-11-15', verified: true, location: 'Paris, France' },
  ],
  '4': [
    { id: 'r4-1', author: 'Nina V.', rating: 5, title: 'Clean and modern', text: 'The minimalist aesthetic is perfect. Clean lines, great proportions.', date: '2026-01-22', verified: true, location: 'Amsterdam, Netherlands' },
    { id: 'r4-2', author: 'Hugo F.', rating: 5, title: 'SketchUp perfection', text: 'Finally a SketchUp template that is properly organized with scenes and layers.', date: '2026-01-08', verified: true, location: 'Paris, France' },
    { id: 'r4-3', author: 'Mia C.', rating: 4, title: 'Good starting point', text: 'Nice template, needed some tweaking for my specific use case but saved time overall.', date: '2025-12-25', verified: true, location: 'Los Angeles, USA' },
    { id: 'r4-4', author: 'Alex B.', rating: 5, title: 'Great for clients', text: 'The render-ready scenes impressed my clients right away.', date: '2025-12-12', verified: true, location: 'Sydney, Australia' },
    { id: 'r4-5', author: 'Chloe W.', rating: 5, title: 'Love it', text: 'Simple, elegant, functional. This is what good architecture templates should be.', date: '2025-12-01', verified: true, location: 'Melbourne, Australia' },
  ],
  '5': [
    { id: 'r5-1', author: 'James R.', rating: 5, title: 'Luxury done right', text: 'The level of detail in this penthouse template is staggering. Every fixture is modeled.', date: '2026-01-25', verified: true, location: 'London, UK' },
    { id: 'r5-2', author: 'Isabella M.', rating: 5, title: 'Worth every euro', text: 'Presented this to a client and they approved the design concept immediately.', date: '2026-01-14', verified: true, location: 'Milan, Italy' },
    { id: 'r5-3', author: 'Stefan L.', rating: 5, title: 'Premium quality', text: 'This is what premium means. Revit families, schedules, everything included.', date: '2025-12-30', verified: true, location: 'Vienna, Austria' },
    { id: 'r5-4', author: 'Nadia K.', rating: 4, title: 'Almost perfect', text: 'Gorgeous template. Would love to see a version with terrace options.', date: '2025-12-15', verified: true, location: 'Amsterdam, Netherlands' },
    { id: 'r5-5', author: 'Oscar T.', rating: 5, title: 'Stunning', text: 'The penthouse views are already set up for renders. Saved me hours.', date: '2025-12-01', verified: true, location: 'Stockholm, Sweden' },
    { id: 'r5-6', author: 'Laura P.', rating: 5, title: 'Client approved', text: 'Used as-is for a pitch. Client loved it. Converting to final plans now.', date: '2025-11-20', verified: true, location: 'Stuttgart, Germany' },
  ],
  '6': [
    { id: 'r6-1', author: 'Green Studio', rating: 5, title: 'Comprehensive landscape', text: 'Finally a landscape template that includes proper planting schedules.', date: '2026-01-20', verified: true, location: 'Portland, USA' },
    { id: 'r6-2', author: 'Patrick O.', rating: 4, title: 'Good foundation', text: 'Solid master plan template. Added our own planting palette and it worked great.', date: '2025-12-28', verified: true, location: 'Dublin, Ireland' },
    { id: 'r6-3', author: 'Yoko S.', rating: 5, title: 'Beautiful', text: 'The 3D vegetation models are excellent quality.', date: '2025-12-10', verified: true, location: 'Tokyo, Japan' },
    { id: 'r6-4', author: 'Martin H.', rating: 5, title: 'Time saver', text: 'Landscape plans usually take forever. This cut my time by 60%.', date: '2025-11-25', verified: true, location: 'Hamburg, Germany' },
    { id: 'r6-5', author: 'Zara A.', rating: 4, title: 'Useful', text: 'Good template, would appreciate more hardscape options in future updates.', date: '2025-11-10', verified: true, location: 'London, UK' },
  ],
  '7': [
    { id: 'r7-1', author: 'Brooklyn Design', rating: 5, title: 'Industrial perfection', text: 'The exposed structure details are amazing. Saved us weeks of modeling.', date: '2026-01-18', verified: true, location: 'New York, USA' },
    { id: 'r7-2', author: 'Felix R.', rating: 5, title: 'Trend-ready', text: 'Perfect for the current loft conversion trend. Clients love the industrial aesthetic.', date: '2026-01-05', verified: true, location: 'Munich, Germany' },
    { id: 'r7-3', author: 'Diana C.', rating: 4, title: 'Very detailed', text: 'Impressive steel structure modeling. Great reference even if you customize heavily.', date: '2025-12-20', verified: true, location: 'London, UK' },
    { id: 'r7-4', author: 'Sam N.', rating: 5, title: 'Best loft template', text: 'Tried three other loft templates before finding this one. This is the one.', date: '2025-12-05', verified: true, location: 'Chicago, USA' },
    { id: 'r7-5', author: 'Katja W.', rating: 5, title: 'Client magnet', text: 'Every client wants a loft conversion these days. This template makes it easy.', date: '2025-11-18', verified: true, location: 'Berlin, Germany' },
  ],
  '8': [
    { id: 'r8-1', author: 'Retail Arch Co.', rating: 5, title: 'Great for retail', text: 'The display fixtures and lighting layout saved us so much time.', date: '2026-01-22', verified: true, location: 'New York, USA' },
    { id: 'r8-2', author: 'Kevin L.', rating: 4, title: 'Good value', text: 'Affordable entry point for retail design. Clean Revit model.', date: '2026-01-08', verified: true, location: 'San Francisco, USA' },
    { id: 'r8-3', author: 'Monica A.', rating: 5, title: 'Quick turnaround', text: 'Had to deliver a retail concept in 3 days. This template made it possible.', date: '2025-12-25', verified: true, location: 'Milan, Italy' },
    { id: 'r8-4', author: 'Tom B.', rating: 4, title: 'Solid template', text: 'Good base for retail projects. Easy to customize to different store types.', date: '2025-12-10', verified: true, location: 'London, UK' },
  ],
};
